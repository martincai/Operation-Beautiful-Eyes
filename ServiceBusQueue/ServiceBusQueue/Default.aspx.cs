...
namespace ServiceBusQueue
{
    ...
    //CloudConfigurationManager.GetSetting("Microsoft.ServiceBus.ConnectionString");
            ...
            message.Properties["Name"] = "Jolia";
            message.Properties["IsWatching"] = true;
  ...
  //CloudConfigurationManager.GetSetting("Microsoft.ServiceBus.ConnectionString");
            ...
            */
            ...
            try
            {
                if (message != null) { Label1.Text = "MessageID: " + message.MessageId + " Name: " + message.Properties["Name"] + " Time: " + message.Properties["Time"]; message.Complete(); }
